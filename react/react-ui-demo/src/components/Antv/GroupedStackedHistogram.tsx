...
const GroupedStackedHistogram: React.FC = (props: any) => {
  useEffect(() => {
    const data = [
      {
        State: 'AL',
    ...
    const chart = new Chart({
      container: 'grouped-stacked-histogram',
      autoFit: true,
    })
  ...
  return (
    <>
      ...
      <div id="grouped-stacked-histogram" style={{ width: '100%', height: '80%' }}></div>
    </>
  )
}

export default GroupedStackedHistogram
