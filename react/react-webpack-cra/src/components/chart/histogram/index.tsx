  ...
  return (
    <Chart height={height} width={575} autoFit data={data} interactions={['active-region']} padding={[20, 30, 50, 35]} scale={cols}>
      ...
      <Tooltip
        ...
        // }}
        showTitle={false}
        containerTpl={'<div class="g2-tooltip">' + '<div class="g2-tooltip-title" style="margin-bottom: 4px;"></div>' + '<ul class="g2-tooltip-list" style="height: 50px;"></ul>' + '</div>'}
        itemTpl={'<li data-index={index} style="margin-bottom:4px;">' + '{nameStar}~{nameEnd}分数段<br /><br />' + '<span style="background-color:{color};" class="g2-tooltip-marker"></span>' + '<span style="padding-left: 2px">人数：{value}</span><br />' + '</li>'}
      />
    </Chart>
  )
}
