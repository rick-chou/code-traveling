...
const isArray: (obj: any) => boolean = obj => Object.prototype.toString.call(obj) === '[object Array]';

const isDate: (obj: any) => boolean = obj => Object.prototype.toString.call(obj) === '[object Date]';

const isRegExp: (obj: any) => boolean = obj => Object.prototype.toString.call(obj) === '[object RegExp]';

const isBoolean: (obj: any) => boolean = obj => Object.prototype.toString.call(obj) === '[object Boolean]';

const isNumerical: (obj: any) => boolean = obj => Object.prototype.toString.call(obj) === '[object Number]';
...
const pick: (object: Record<string, unknown>, keys: string[]) => Record<string, unknown> = (object, keys) => {
...
const omit: (object: Record<string, unknown>, keys: string[]) => Record<string, unknown> = (object, keys) => {
  const shallowCopy = {
    ...object,
  };
...
const chunk: (arr: any[], chunkSize?: number, cache?: any[]) => any[] = (arr, chunkSize = 1, cache = []) => {
  const tmp = [...arr];
  if (chunkSize <= 0) {
    return cache;
  }
