...
import { ColorPropType, Animated, StyleSheet, PanResponder, View, Easing, ViewPropTypes } from 'react-native';
...
export default class Slider extends Component {
    ...
    if (this.props.stepValue) {
      return Math.max(
        ...
        Math.min(
          ...
          Math.round((ratio * (this.props.maximumValue - this.props.minimumValue)) / this.props.stepValue) *
  ...
  renderMaxNounView = () => {
    const { horizontal, maxNounStyle, stepValue, minimumValue, maximumValue, type, thumbTouchSize, reverseValue } =
      this.props;
  ...
  renderMinNounView = () => {
    const { horizontal, minNounStyle, stepValue, minimumValue, maximumValue, type, reverseValue, thumbTouchSize } =
      this.props;
  ...
  render() {
    ...
    return (
      <View
        ...
        <View style={[defaultStyles.touchArea, touchOverflowStyle]} {...this._panResponder.panHandlers}>
...
Slider.Vertical = _props => <Slider {..._props} ref={_props.sliderRef} horizontal={false} styles={verticalStyles} />;
